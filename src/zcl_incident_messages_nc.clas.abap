CLASS zcl_incident_messages_nc DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      gc_msgid TYPE symsgid VALUE 'ZMC_INCT_MESSAGE_NC',

      BEGIN OF status_invalid,
        msgid TYPE symsgid VALUE 'ZMC_INCT_MESSAGE_NC',
      ...
      BEGIN OF customer_unkown,
        ...
        attr1 TYPE scx_attrname VALUE 'MV_CUSTOMER_NC',
        attr2 TYPE scx_attrname VALUE '',
        attr3 TYPE scx_attrname VALUE '',
        attr4 TYPE scx_attrname VALUE '',
      ...
      BEGIN OF agency_unkown,
        ...
        attr1 TYPE scx_attrname VALUE 'MV_AGENCY_NC',
        attr2 TYPE scx_attrname VALUE '',
        attr3 TYPE scx_attrname VALUE '',
        attr4 TYPE scx_attrname VALUE '',
    ...
    METHODS constructor
      IMPORTING
        ...
        status                TYPE zde_status_nc OPTIONAL
...
CLASS zcl_incident_messages_nc IMPLEMENTATION.
